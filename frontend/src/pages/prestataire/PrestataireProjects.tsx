  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link to="/prestataire/projects/new">
          ...
          <Card key={project.id} className="hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent>
              ...
              <div className="flex space-x-3">
                ...
                <Link to={`/prestataire/projects/${project.id}/documents`} className="flex items-center space-x-2 px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors">
